...
svg.append("text")
    .attr("transform", "translate(" + (width/2 + margin -20) + " ," + (height+2*margin -24) + ")") /*may need to tweak this as margin and font size changes ... width/2 + margin -xxx*/
    .attr("dx", "1em")
...
var legend = svg.selectAll(".legend")
    ...
    .attr("transform", function(d,i) { return "translate(" + i%n * 130 + "," + Math.floor(i/n) * 100 + ")"; });
...
legend.append("rect")
    ...
    .attr("width", 18)
    .attr("height", 18)
    /*.style('fill', function (d) { return options.colour2[groupNames.indexOf(d.var2)]; })*/
    .style('fill', colour)
    /*.attr("y", 6)*/
    .attr("y", height + margin +53)
